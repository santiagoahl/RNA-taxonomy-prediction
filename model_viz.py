...
Author: Santiago Ahumada Lozano
"""
...
def plot_tr_matrices(new_data):
  ...
  fig.show()
  plt.savefig('/content/drive/MyDrive/Grupo-ai-Medicos/Results/matrices_distribution.png')
...
def plot_markov_chain(matrix):  
  ...
  plt.savefig('/content/drive/MyDrive/Grupo-ai-Medicos/Results/markov_chain.png')
  plt.show()
...
def plot_cmat(cm, taxonomies):
  ...
  fig.savefig('/content/drive/MyDrive/Grupo-ai-Medicos/Results/confussion_matrix.png', dpi=100)
